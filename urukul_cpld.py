...
_io = [
        ...
        ("clk_div", 0, Pins("P11"), IOStandard("LVCMOS33")),
        ("in_sel", 0, Pins("P12"), IOStandard("LVCMOS33")),
        ...
        ("dds_sync", 0,
            ...
            Subsignal("clksel", Pins("60")),
            Subsignal("clk_out_en", Pins("P86")),
            Subsignal("out_en", Pins("P92")),
            IOStandard("LVCMOS33")),

        ("dds", 0,
            Subsignal("rf_sw", Pins("P103")),
            Subsignal("led", Pins("P128 P126")),
            Subsignal("smp_err", Pins("P19")),
            Subsignal("pll_lock", Pins("P21")),
            Subsignal("update", Pins("P4")),
            Subsignal("sck", Pins("P3")),
            Subsignal("sdo", Pins("P2")),
            Subsignal("sdi", Pins("P113")),
        ...
        ("dds", 1,
            ...
            Subsignal("smp_err", Pins("P28")),
            Subsignal("pll_lock", Pins("P35")),
            Subsignal("update", Pins("P10")),
        ...
        ("dds", 2,
            ...
            Subsignal("smp_err", Pins("P40")),
            Subsignal("pll_lock", Pins("P41")),
            Subsignal("update", Pins("P14")),
            Subsignal("sck", Pins("P13")),
            Subsignal("sdo", Pins("P17")),
            Subsignal("sdi", Pins("P115")),
        ...
        ("dds", 3,
            ...
            Subsignal("smp_err", Pins("P39")),
            Subsignal("pll_lock", Pins("P49")),
            Subsignal("update", Pins("P25")),
